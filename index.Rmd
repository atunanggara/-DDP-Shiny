...
avemidterm<- ((95+75+85)/3)*0.4
cat("Average of Midterm Grades (out of 40%):",avemidterm)
avenonmidterm<-(90*0.10+100*0.05+90*0.15+100*0.10)
cat("Average of non-midterm Grades (out of 40%):",avenonmidterm)
totalpoint<- avemidterm+avenonmidterm+60*0.2
cat("Raw Total Grade (out of 100):",totalpoint)

if(totalpoint >= 93){
  cat("Your final grade: A")
} else if (totalpoint >= 90) {
    cat("Your final grade: A-")
} else if (totalpoint >= 87) {cat("Your final grade: B+")
} else if (totalpoint >= 83) {cat("Your final grade: B")
} else if (totalpoint >= 80) {cat("Your final grade: B-")
} else if (totalpoint >= 77) {cat("Your final grade: C+")
} else if (totalpoint >= 73) {cat("Your final grade: C")
} else if (totalpoint >= 70) {cat("Your final grade: C-")
} else if (totalpoint >= 60) {cat("Your final grade: D")
                } else {cat("Your final grade:F")}
```
